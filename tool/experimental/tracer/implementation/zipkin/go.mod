module github.com/facebookincubator/go-belt/tool/experimental/tracer/implementation/zipkin

go 1.18

require (
	github.com/facebookincubator/go-belt v0.0.0-20221024173957-c700cceba34e
